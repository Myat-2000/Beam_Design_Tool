...
interface BeamResultsPanelProps {
  diagramData: any[];
  theme: string;
  beamLength: number;
...
const BeamResultsPanel: React.FC<BeamResultsPanelProps> = ({
  diagramData,
  theme,
  beamLength,
  materialProps,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 transition-colors">
        ...
        <div className="h-120">
          <BeamDeformationVisualization
            ...
            momentOfInertia={0} // Pass correct value if needed
          />
        </div>
      </div>
...
export default BeamResultsPanel; 